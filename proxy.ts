...
export const config={matcher:['/','/today','/projects/:path*','/calendar','/requests/:path*','/assets/:path*','/login','/forgot-password','/reset-password','/agreements/:path*','/api/:path*','/content-radar/:path*']};
