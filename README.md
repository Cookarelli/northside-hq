...
- At store opening, the checklist remains available under **Projects → Archived / Completed** with a launch summary and editable remaining work. The existing URL, records and history are preserved; sunset changes presentation only.
