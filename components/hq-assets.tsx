...
export function HqAssets(){
 ...
 {tab==='all-assets'&&<div className="section-title"><div><h2>All Assets</h2><p className="hq-meta">Shared files for Northside projects and deliverables.</p></div><Link href="/assets/research">Research &amp; sources →</Link></div>}
