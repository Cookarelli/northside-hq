...
const homeTabs=[{id:'my-work',label:'My Assignments'},{id:'schedule',label:'Schedule'},{id:'projects',label:'Active projects'},{id:'activity',label:'Recent activity'}];
